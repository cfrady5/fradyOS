...
export function SettingsView(props: {
  ...
  workAreas: WorkArea[];
  email: string | null;
  monday: { tokenConfigured: boolean; connections: { events: MondayConnection | null; social: MondayConnection | null }; runs: MondaySyncRun[]; webhookUrl: string | null };
    ...
    <div className="mx-auto max-w-4xl">
      ...
      <Tabs value={props.tab} onValueChange={(v) => router.push(`${pathname}?tab=${v}`)}>
        ...
        <TabsContent value="monday">
          <MondaySettings tokenConfigured={props.monday.tokenConfigured} connections={props.monday.connections} runs={props.monday.runs} webhookUrl={props.monday.webhookUrl} cronConfigured={props.cronConfigured} adminConfigured={props.adminConfigured} workAreas={props.workAreas} />
        </TabsContent>
